...
{
    uart_driver_install(UART_NUM_2, BUFFER_SIZE * 2, BUFFER_SIZE * 2, 0, NULL, 0);
}
...
void UART2_writeBytes(const char* bytes, size_t len)
{
    uart_write_bytes(UART_NUM_2, bytes, len);
}